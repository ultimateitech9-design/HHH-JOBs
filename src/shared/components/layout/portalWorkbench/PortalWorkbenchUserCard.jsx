const PortalWorkbenchUserCard = ({ avatarLetter, avatarUrl, collapsed = false, name, subtitle }) => {
  return (
    <div className="flex items-center gap-3 rounded-2xl px-3 py-2.5 text-sm font-medium text-slate-500 transition-colors hover:bg-slate-100 hover:text-slate-900">
