...
const HrDashboardPage = () => {
  ...
  return (
    <div className="dashboard-page dashboard-page--hr dashboard-page--hr-modern">
      ...
      {!state.loading ? (
        <>
          <section className="dash-card hr-panel">
            <div className="dash-card-head">
              <h3>HR ID</h3>
            </div>
            <p className="module-note">{hrEmployerId}</p>
          </section>
          ...
          <section className="hr-main-grid">
            ...
            <aside className="hr-right-column">
              <article className="dash-card hr-panel">
                <div className="dash-card-head">
                  <h3>Retired Hiring</h3>
                  <Link to="/portal/hr/jobs" className="inline-link">Open Jobs</Link>
                </div>
                <p className="module-note">
                  Choose the right candidate group while posting jobs, including dedicated opportunities for retired professionals.
                </p>
                <div className="student-job-actions">
                  <Link to="/portal/hr/jobs?audience=retired_employee" className="btn-primary">Post for Retired Employees</Link>
                </div>
              </article>
