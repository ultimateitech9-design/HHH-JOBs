    ...
    },
    {
      ...
      render: (value) => (
        <div className="student-job-actions">
          <Link to={`/portal/dataentry/edit-entry?entryId=${value}`} className="btn-link">Edit</Link>
          <Link to={`/portal/dataentry/upload-images?entryId=${value}`} className="btn-link">Images</Link>
        </div>
      )
    }
  ];
