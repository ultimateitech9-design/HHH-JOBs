    ...
    <div className="module-page module-page--student">
      ...
      <section className="panel-card">
        <div className="student-filters">
          ...
          />
          {hasFilters ? (
            <button type="button" className="btn-link" onClick={() => setFilters(makeDefaultFilters(effectiveAudience))}>
              Reset Filters
            </button>
          ) : null}
        </div>
          ...
          return (
            <article className="student-job-card" key={jobId}>
              ...
              {(job.targetAudience || job.audience) && String(job.targetAudience || job.audience).toLowerCase() !== 'all' ? (
                <p>Audience: {String(job.targetAudience || job.audience).replace('_', ' ')}</p>
              ) : null}
              <p>
              ...
              <div className="student-job-actions">
                <Link to={`${detailsPathBase}/${jobId}`} className="btn-link">Details</Link>
